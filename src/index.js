...
<p id="kpempty" class="hidden mt-4 text-sm text-slate-500">没有匹配「<b id="kpemptyq" class="text-slate-700"></b>」的考点，试试更短的关键词，或 <a href="#" onclick="event.preventDefault();var q=document.getElementById('kpq');q.value='';kpfilter('');q.focus()" class="text-rose-600 underline">清空筛选</a>。</p>
