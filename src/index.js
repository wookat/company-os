...
<p class="mt-3 text-xs text-slate-500">时间不够整卷？<a class="inline-flex items-center min-h-[32px] py-1.5 text-rose-600 underline font-medium" href="/app2/#realrand">🎲 全库随机 20 题快刷 →</a></p></div>
